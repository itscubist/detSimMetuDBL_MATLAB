...
start = tic(); % Start measuring time
...
row_divide = 4; % Resolution in cm will be 1.41/row_divide
column_divide = 4; % Resolution in cm will be 1.41/column_divide
...
obtain_clustering_statistics = false; % If statistics are desired
...
tic
filename = '../simulation_output/flux1e7_alpha_250000nsshutter_20frame'; % Saved Name (also with Directory if desired)
...
[a] = toc();
disp(['Time_area_norm2 : ', num2str(a)]);
% sub_hits
% total_hit
%flux_divider
...
toc(start) % Measure elaspsed time
